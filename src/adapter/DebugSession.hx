...
extern class DebugSession extends ProtocolServer {
	...
	function sendErrorResponse<T>(response:Response<T>, codeOrMessage:haxe.extern.EitherType<Int, Message>, ?format:String, ?variables:Dynamic,
		dest:String = "user"):Void;
